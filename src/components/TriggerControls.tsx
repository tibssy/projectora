                    ...
                    <div className="w-full">
                        <div className="flex justify-between items-center mb-1">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setIsProximityEnabled(e.target.checked)
                                }
                        ...
                        {isProximityEnabled && (
                            <div>
                                <label
                                    ...
                                    className="block text-xs text-light-text/70 dark:text-dark-text/70 mb-1"
                                >
                                    Closeness Threshold:{" "}
                                    {proximityThreshold.toFixed(2)}
                                </label>
                                <input
                                    id="proximity-slider"
                                    type="range"
