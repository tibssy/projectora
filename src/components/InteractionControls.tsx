        ...
        <div className="p-4 bg-light-surface dark:bg-dark-surface rounded-lg space-y-4">
            ...
            <div>
                ...
                <div className="p-4 bg-light-base dark:bg-dark-base rounded-lg text-xs font-mono">
                    ...
                    <p>
                        X (raw): {latestLandmark?.x.toFixed(3)} | X (smooth):{" "}
                        <span className="font-bold">
                            {smoothedLandmark?.x.toFixed(3)}
                        </span>
                    </p>
                    <p>
                        Y (raw): {latestLandmark?.y.toFixed(3)} | Y (smooth):{" "}
                        <span className="font-bold">
                            {smoothedLandmark?.y.toFixed(3)}
                        </span>
                    </p>
                    <p>
                        Z (raw): {latestLandmark?.z.toFixed(3)} | Z (smooth):{" "}
                        <span className="font-bold">
                            {smoothedLandmark?.z.toFixed(3)}
                        </span>
                    </p>
                </div>
            </div>
